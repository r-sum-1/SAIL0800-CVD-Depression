 -------- Drop if necessary  --------
DROP TABLE SAILW0800V.GP_EVENTS_OF_INTEREST_HIST;

 -------- Create table --------
CREATE TABLE SAILW0800V.GP_EVENTS_OF_INTEREST_HIST AS (
...
RIGHT JOIN (
	...
	AND NOT readcodes."pre2010" = 0) WITH NO DATA ;
		

	
 -------- insert CVD readcodes  -------- 
INSERT INTO SAILW0800V.GP_EVENTS_OF_INTEREST_HIST(
	SELECT ch.ALF_PE, ch.ENTER_COHORT, ch.EXIT_COHORT, gp.EVENT_CD, gp.EVENT_VAL, gp.EVENT_DT, readcodes.READ_CODE, readcodes.READ_TYPE, readcodes."pre2010" AS pre_2010, readcodes."StudyPeriod20102019" AS study_period  FROM SAILW0800V.COHORT_ENTRY ch
LEFT JOIN (
	SELECT *
	FROM SAIL0800V.WLGP_GP_EVENT_CLEANSED_20220101) AS gp
...
INSERT INTO SAILW0800V.GP_EVENTS_OF_INTEREST_HIST (SELECT ch.ALF_PE, 
	ch.ENTER_COHORT, 
	ch.EXIT_COHORT, 
	'alt.anx' AS EVENT_CD, 
	NULL AS EVENT_VAL,
	...
	1 AS STUDY_PERIOD
		...
		WHERE aad.EVENT_DT < ENTER_COHORT);
